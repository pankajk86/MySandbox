...
import tiny.url.Base62;

public class TinyURL {

	private static Long GLOBAL_ID = 1L;
	private static final Map<Long, String> id2UrlMap = new HashMap<>();
	private static final Map<String, Long> url2IdMap = new HashMap<>();
	
	public static void main(String[] args) {

        List<String> urls = new ArrayList<>(Arrays.asList(
				"http://www.google.com/abc/def.html",
