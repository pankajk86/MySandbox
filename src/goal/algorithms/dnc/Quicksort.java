...
public class Quicksort {
    ...
    public static void quickSort(int arr[], int left, int right) {
        ...
        if (size > 1) {
            /*
             * we can choose any pivot element in the array. Here, we have
             * chosen the middle element as one.
             */
            ...
            while (left <= right) {
                ...
                /*
                 * Now, at this point (after previous two loops), if left <
                 * right, it means that value of pivot is lesser than that of
                 * arr[left]. hence we swap the value.
                 */
                if (left <= right) {
