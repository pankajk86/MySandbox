...
public class MyLinkedList {
    ...
    public void add(Object value) {
        ...
        // if head is null, it means the list is empty; we will set head with
        // "node".
        if (head == null) {
            head = node;
        }
        // if head is not null, we will set "node" as the next node of the last
        // node in the list.
        else {
            Node current = head;
    ...
    public void remove(Object value) {
        ...
        while (current.getData() != value) {
            // we have reached till the end of the list, and haven't found the
            // "value".
