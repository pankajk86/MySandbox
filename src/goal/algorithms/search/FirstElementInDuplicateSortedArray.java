...
public class FirstElementInDuplicateSortedArray {
    ...
    private static int searchFirst(int[] arr, int left, int right, int data) {
        ...
        /*
         * Here, we have put two conditions: 1. This is a special case, when the
         * searched item is the very beginning of the list. For this, we don't
         * have any further elements before the very first element to compare
         * with (that, this is greater than the element before that). That's
         * why, we have put the condition: (mid == left).
         * 
         * 2. With the explanation of 1., the second condition is simpler. That
         * is, we want to make sure that element before the current element,
         * i.e. arr[mid] is lesser than data, hence, arr[mid] is the first
         * element with data as it's value.
         */
